...
module_dir = os.path.join(__location__, "../src/pyskyq")
try:
...
try:
    from pyskyq import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'user_guide.tex', u'pyskyq Documentation',
   u'Bradley Wood', 'manual'),
]
